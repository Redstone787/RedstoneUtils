...
package io.github.redstone787.redstone_utils.client.calculator;
...
final class CalculatorExpression {
    ...
    private static final class Parser {
        ...
        private void expect(char expected) {
            if (!match(expected)) throw error(Component.translatable("calculator.redstone_utils.error.expected", expected).getString());
        }
        ...
        private IllegalArgumentException error(String message) {
            return new IllegalArgumentException(Component.translatable("calculator.redstone_utils.error.position", message, index).getString());
        }
    }

    private static String message(String suffix) {
        return Component.translatable("calculator.redstone_utils.error." + suffix).getString();
    }
}
