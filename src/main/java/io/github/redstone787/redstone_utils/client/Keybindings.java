...
import io.github.redstone787.redstone_utils.client.ui.CircleSegment;
...
import io.github.redstone787.redstone_utils.client.ui.ToolboxScreen;
...
public final class Keybindings {
    ...
    public static void init() {
        register(generateKey("key.redstone_utils.teleport"), TpUtil::teleportToBlock);
        register(generateKey("key.redstone_utils.toolbox"), ToolboxScreen::open);
        wireMenuKey = generateKey("key.redstone_utils.wire");
    ...
    private static void openWireMenuScreen() {
        ...
        if (!RedstoneOverlay.isVisible()) {
            RedstoneMessages.chat(Component.translatable("message.redstone_utils.wire_menu.hud_disabled"));
            return;
        }
