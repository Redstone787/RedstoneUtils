...
package io.github.redstone787.redstone_utils.client.overlay;
...
public final class OverlayFreeze {
    ...
    public static void setAllFrozen(boolean frozen) {
        ...
        RedstoneMessages.popup(Component.translatable(
                "message.redstone_utils.overlays.frozen",
                Component.translatable(frozen ? "state.redstone_utils.on" : "state.redstone_utils.off")
        ));
    }
}
