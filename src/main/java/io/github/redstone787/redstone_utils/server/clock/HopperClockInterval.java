...
public record HopperClockInterval(int itemCount) {
    ...
    public static ParseResult parse(String value) {
        ...
        try {
            ...
            return ParseResult.failure(Component.translatable("message.redstone_utils.clock.whole_game_ticks"));
        }
    ...
    private static ParseResult unsupportedPeriod() {
        return ParseResult.failure(Component.translatable("message.redstone_utils.clock.hopper_range"));
    }
