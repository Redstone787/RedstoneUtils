...
import io.github.redstone787.redstonelabworks.client.util.ClientThreads;
...
final class PopupOverlay {
    ...
    private static final class PopupMessage {
        ...
        private boolean shouldExit(long now) {
            return exitStartedAt == -1L && now - createdAt >= ENTER_TIME + RedstoneLabworksConfig.getPopupDurationMillis();
        }
        ...
        private boolean rightAnchored() {
            return RedstoneLabworksConfig.getPopupAnchor() == RedstoneLabworksConfig.PopupAnchor.TOP_RIGHT
                    || RedstoneLabworksConfig.getPopupAnchor() == RedstoneLabworksConfig.PopupAnchor.BOTTOM_RIGHT;
        }

        private boolean bottomAnchored() {
            return RedstoneLabworksConfig.getPopupAnchor() == RedstoneLabworksConfig.PopupAnchor.BOTTOM_LEFT
                    || RedstoneLabworksConfig.getPopupAnchor() == RedstoneLabworksConfig.PopupAnchor.BOTTOM_RIGHT;
        }
