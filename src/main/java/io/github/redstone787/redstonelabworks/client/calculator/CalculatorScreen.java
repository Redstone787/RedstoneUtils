...
final class CalculatorScreen extends Screen {
    ...
    CalculatorScreen() {
        super(Component.translatable("screen.redstonelabworks.calculator"));
    }
    ...
    private void drawPanel(GuiGraphicsExtractor graphics, CalculatorLayout layout) {
        ...
        graphics.text(font, Component.translatable("screen.redstonelabworks.calculator"), layout.x() + layout.padding(), layout.y() + 7, TEXT_COLOR, false);
    }
    ...
    private void evaluate() {
        ...
        try {
            ...
            error = exception.getMessage() == null || exception.getMessage().isBlank()
                    ? Component.translatable("calculator.redstonelabworks.error.invalid").getString()
