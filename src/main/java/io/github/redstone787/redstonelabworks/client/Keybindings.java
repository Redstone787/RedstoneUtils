...
import io.github.redstone787.redstonelabworks.client.ui.CircleSegment;
...
public final class Keybindings {
    ...
    private static final KeyMapping.Category CATEGORY = KeyMapping.Category.register(RedstoneLabworks.id("general"));
    ...
    public static void init() {
        register(generateKey("key.redstonelabworks.teleport"), TpUtil::teleportToBlock);
        register(generateKey("key.redstonelabworks.toolbox"), ToolboxScreen::open);
        wireMenuKey = generateKey("key.redstonelabworks.wire");
    ...
    private static void openWireMenuScreen() {
        ...
        if (!RedstoneOverlay.isVisible()) {
            RedstoneMessages.chat(Component.translatable("message.redstonelabworks.wire_menu.hud_disabled"));
            return;
        }
