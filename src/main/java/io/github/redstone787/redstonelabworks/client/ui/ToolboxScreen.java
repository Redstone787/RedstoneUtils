...
/** A command-free entry point to all major RedstoneLabworks tools. */
public final class ToolboxScreen extends Screen {
    ...
    private final List<Tool> tools = List.of(
            new Tool("toolbox.redstonelabworks.autowire", this::nextAutoWire),
            new Tool("toolbox.redstonelabworks.overlays", this::toggleOverlays),
            new Tool("toolbox.redstonelabworks.clock", () -> openCommand("/clock ")),
            new Tool("toolbox.redstonelabworks.signal", () -> openCommand("/signal ")),
            new Tool("toolbox.redstonelabworks.calculator", () -> Calculator.openCalculator()),
            new Tool("toolbox.redstonelabworks.macros", RedstoneLabworksClientActions::openMacros),
            new Tool("toolbox.redstonelabworks.config", RedstoneLabworksClientActions::openConfig),
            new Tool("toolbox.redstonelabworks.freeze", OverlayFreeze::toggleAll)
    );

    public ToolboxScreen() {
        super(Component.translatable("screen.redstonelabworks.toolbox"));
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float deltaTicks) {
        ...
        graphics.text(font, Component.translatable("screen.redstonelabworks.toolbox.subtitle"), x + 14, y + 30, RedstoneUi.MUTED_TEXT_COLOR, false);
        ...
        String profile = Component.translatable("screen.redstonelabworks.toolbox.profile", io.github.redstone787.redstonelabworks.client.config.RedstoneLabworksConfig.activeProfile()).getString();
    ...
    private void toggleOverlays() {
        RedstoneLabworksClientActions.setAllOverlays(!RedstoneLabworksClientActions.allOverlaysVisible());
    }
